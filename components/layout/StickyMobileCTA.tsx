...
export default function StickyMobileCTA() {
  return (
    <div className="fixed bottom-0 left-0 right-0 z-40 block border-t border-[var(--border-subtle)] bg-[var(--background)]/95 px-4 py-3 pb-[max(0.75rem,env(safe-area-inset-bottom))] backdrop-blur supports-[backdrop-filter]:bg-[var(--background)]/90 md:hidden">
      <Link
        href="/intake"
