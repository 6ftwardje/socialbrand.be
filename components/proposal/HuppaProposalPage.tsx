...
export default function HuppaProposalPage() {
  ...
  return <div className="proposal-page huppa-proposal">
    ...
    <div>
      ...
      <section className="proposal-section proposal-photo"><div className="proposal-container photo-grid"><div><p className="proposal-number">03</p><p className="proposal-eyebrow">Fotografie</p></div><AnimateOnScroll><div><h2>Beeld dat ook buiten video blijft werken.</h2><strong className="photo-count">30<span>+</span></strong><p className="proposal-lead">Afgewerkte campagnebeelden, portretten, werk-, detail- en behind-the-scenesbeelden. Selectie, basisretouche en web- en socialvriendelijke exports inbegrepen.</p></div></AnimateOnScroll></div></section>
